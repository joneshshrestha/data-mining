...
class MovieSimilarities(MRJob):
    ...
    def configure_args(self):
        ...
        self.add_file_arg("--items", help="Path to movies.dat")
    ...
    def steps(self):
        return [
            MRStep(
                mapper=self.mapper_parse_input, reducer=self.reducer_ratings_by_user
            ),
            MRStep(
                mapper=self.mapper_create_item_pairs,
